...
== Version 2.0.0 (March xx, 2012)

* Dropped Rails support (keep it simple and why compete with Jammit, Sprockets or assets pipeline?)
* Supporting Ruby 1.9.2 and 1.9.3
* Added Jzip::CLI
